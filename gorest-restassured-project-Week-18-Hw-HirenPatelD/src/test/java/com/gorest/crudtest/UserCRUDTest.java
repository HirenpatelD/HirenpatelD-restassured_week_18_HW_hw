...
public class UserCRUDTest extends TestBase {
    static String name = TestUtils.getRandomValue() + "Amanda";
    static String email = TestUtils.getRandomValue() + "Amanda123@gmail.com";
...
//    // ======================Update the new user===============================//
    ...
    public void verifyUserUpdateSuccessfully() {
        ...
        UserPojo userPojo = new UserPojo();
        String email = TestUtils.getRandomValue() + "Amandap1234@gmail.com";
        userPojo.setEmail(email);
